 ...
 * and {@link #name} fields. Then {@link UrlHandler}s are processing the URL to create
 ...
 */
public class DefaultUploadValue implements Cloneable, Comparable<UploadValue>, UploadValue {
  ...
  public DefaultUploadValue(URL resource, String name) {
    this.resource = resource;
    this.name = name;
  }

  public DefaultUploadValue(URL imageResource) {
    this.resource = imageResource;
  }

  public DefaultUploadValue(UploadValue value) {
    if (value != null) {
  ...
  @Override
  public void setMissingIcon(int w, int h) {
    this.icon = new ImageIcon(Utils.getMissingImage(w, h));
  }
  ...
  public boolean equals(Object o) {
    ...
    DefaultUploadValue that = (DefaultUploadValue) o;
  ...
  public UploadValue clone() throws CloneNotSupportedException {
    return new DefaultUploadValue(this);
  }
  ...
  public int compareTo(UploadValue o) {
    ...
    return resource.toString().compareTo(o.getResource().toString());
  }
